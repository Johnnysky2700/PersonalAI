...
import { FileText, Hash, House, Scissors, SquarePen, Users, Image, Eraser, LogOut } from 'lucide-react';
            ...
            <div className='my-7 w-full'>
                ...
                <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
                    {navItems.map(({ to, label, Icon }) => (
                        <NavLink to={to} end={to === '/ai'} onClick={() => setSidebar(false)} className={({ isActive }) => `px-3.5 py-2.5 flex items-center gap-3 rounded ${isActive ? 'bg-gradient-to-r from-[#3c81f6] to-[#9234ea] text-white' : ''}`} key={to}>
