...
const Hero = () => {
    ...
    justify-center bg-[url(/gradientBackground.png)] b-cover bg-no-repeat min-h-screen'>
            ...
            <div className='text-center mb-6'>
             ...
             font-semibold mx-auto leading-[1.2]'>Create amazing content <br /> with <span className='text-primary'>AI tools</span></h1>
                <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto'>Transform your content creation with our suite of premium AI tools.
                    Write articles, generate images, Unleash your creativity and elevate your content today.
                </p>
            </div>
            ...
            active:scale-95 transition cursor-pointer'>Start creating now</button>
                <button className='bg-white px-10 py-3 rounded-lg border border-gray-30
            hover:scale-95 transition cursor-pointer'>Watch demo</button>
            </div>
